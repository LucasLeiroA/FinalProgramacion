...
let coleccion = "user/"+id_user+"/articulo";
var var_id; 
...
function ingresoDb() {
 ...
 async function Aceptar(){
    ...
    let categoria = await getItems("user/"+id_user+"/categoria");
    ...
    if(!editStatus){
        ...
        await  IngresarDatos("user/"+id_user+"/articulo" , nuevaData ).then(
        swal({
        ...
        await modificarItem("user/"+id_user+"/articulo" , var_id ,nuevaData).then(
            swal({
