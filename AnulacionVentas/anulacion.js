...
const tablaMuestra2 = document.getElementById("tablaMuestra2");
var var_id;
var var_cliente;
...
async function mostrarTabla(){
    ...
    try {
                    ...
                    for (let item of ventaContado) {
                        ...
                        if (item.tipoVentaId == 1 && item.estadoVenta ==  1 ) {
                            ...
                            <td><Button class="btn-eliminar" data-id="${item.id}">X</Button></td>
                                ...
                                const btnsEliminar = tablaMuestra2.querySelectorAll(".btn-eliminar");
                                ...
                                //Traer la venta para agarra el valor de la cantidad del producto y modificar su estado
                                    ...
                                    await modificarItem("user/"+id_user+"/ventas", IdVenta , newData );
                                ...
                                await modificarItem("user/"+id_user+"/articulo" , ArticuloVentaId , ingresoData)
            ...
            if (TipoVenta=="CuentaCorriente") {
                ...
                await modificarItem("user/"+id_user+"/cuentaCorriente" , cuentaCorrienteId , newCliente);
                ...
                await modificarItem("user/"+id_user+"/EstadoDeCaja" , "2" , nuevoEstado)
